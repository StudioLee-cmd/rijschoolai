...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor rijscholen" }, { href: "/chatbot", anchor: "ai chatbot voor rijscholen" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor rijscholen" }, { href: "/reviews", anchor: "review management voor rijscholen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor rijscholen" }, { href: "/crm", anchor: "crm voor rijscholen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor rijscholen" }],
    }
];
