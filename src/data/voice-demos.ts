...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een leerling belt voor een proefles; de agent vraagt naar rijervaring en plant de eerste les met de juiste instructeur.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een leerling wil de rijles van morgen verzetten omdat ’ie ziek is.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een ouder vraagt ’s avonds wat een lespakket kost en hoe lang het duurt tot het examen.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
